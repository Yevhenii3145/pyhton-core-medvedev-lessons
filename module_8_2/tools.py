def load():
    objects = []
    with open(r"C:\Users\Admin\Desktop\python-core-medvedev-lessons\module_8_2\save.txt", "r") as file:
...
def save(objects, turns, size_m, size_n):
    with open(r"C:\Users\Admin\Desktop\python-core-medvedev-lessons\module_8_2\save.txt", "w") as file:
