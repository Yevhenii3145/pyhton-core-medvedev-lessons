...
def check_state(char_x, char_y, char_sign, enemy_x, enemy_y, exit_x, exit_y):
...
while True:
    char_sign, end_flag = check_state(char_x, char_y, char_sign, enemy_x,
                                      enemy_y, exit_x, exit_y)
